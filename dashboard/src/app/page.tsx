      ...
      <div className="text-center">
        <div style={{ position: 'relative', display: 'inline-block', marginBottom: 24, padding: '0 20px' }}>
          ...
          <div style={{
            ...
            height: '55%', zIndex: 1, overflow: 'hidden',
            borderRadius: '4px 4px 30px 30px',
          }}>
            <div style={{
              position: 'absolute', bottom: 0, left: 0, right: 0,
              background: 'linear-gradient(180deg, rgba(125,211,248,0.6), rgba(10,92,138,0.7))',
              animation: 'fillWater 2.5s ease-in-out infinite alternate',
    ...
    <div className="min-h-screen flex flex-col" style={{ background: '#F0F7FC' }}>
      ...
      <nav className="text-white px-6 py-4 flex items-center justify-between shadow-lg"
        ...
        <div className="flex items-center gap-3">
         <div style={{ background: 'rgba(255,255,255,0.95)', borderRadius: 14, padding: '4px 20px', boxShadow: '0 2px 10px rgba(0,0,0,0.2)' }}>
        <img src="/tromen-logo.png" alt="TROMEN" style={{ height: 72, objectFit: 'contain', filter: 'drop-shadow(0 2px 8px rgba(0,0,0,0.4))' }} />
      </div>
          <div>
