  ...
  if (loading) return (
    <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', background: D.bg }}>
      <div style={{ textAlign: 'center' }}>
        ...
        <p style={{ color: D.muted, marginTop: 12, fontWeight: 500 }}>Cargando panel TROMEN...</p>
      </div>
    </div>
  )
    ...
    <div style={{ minHeight: '100vh', background: D.bg, display: 'flex', flexDirection: 'column' }}>
      ...
      <nav style={{ background: D.surface, borderBottom: `1px solid ${D.border}`, padding: '12px 24px', display: 'flex', alignItems: 'center', justifyContent: 'space-between', position: 'sticky', top: 0, zIndex: 40 }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
          ...
          <div>
            <h1 style={{ fontSize: 15, fontWeight: 800, color: D.text, letterSpacing: '-0.3px', lineHeight: 1 }}>TROMEN</h1>
            <p style={{ fontSize: 10, color: D.muted, marginTop: 2 }}>Panel Administrativo · Catriel</p>
          </div>
        </div>
